...
# TODO - сделать разделители цифр а то сомтреть на крупные цифра невозможно
# TODO - сделать приставки k, m вместо Raise 15000 писать Raise 15k, также с блайндами и анте в углу
